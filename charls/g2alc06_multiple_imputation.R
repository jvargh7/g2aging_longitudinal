...
id_vars <- c("w_id","h_id","w_spouseid","h_spouseid","coupleid","h_indsampleweight",
             "w_indsampleweight","communityid","wave","h_hhsampleweight",
             "h_normalizedweight","w_normalizedweight")
...
before_imputation <- charls_unique %>% 
...
saveRDS(mi_dfs, paste0(path_g2a_family_folder,"/charls/G2A CHARLS Couples mi_dfs JV.RDS"))
